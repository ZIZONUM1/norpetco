...
export default function UserData() {
  ...
  const getUserStatistics = async()=>{
    try {
      ...
      const data = await statisticsAPI.getStatistics(id);
  ...
  const filterFunction = () => {
    const filterd = userData?.find((item)=>{
 ...
 useEffect(()=>{
  ...
  return (
    <>
      ...
      >
        <div className="w-[90%] bg-white/90 backdrop-blur-lg shadow-2xl rounded-3xl p-8 sm:p-12 flex flex-col justify-between max-w-6xl mx-auto text-right font-sans">
          {console.log(userData[0])
          }s
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-6">
            <div className="order-2 sm:order-1">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-800">
                أهلاً بك، {userData[0]["إســــــم العــــــامل"]}
              </h2>
 ...
 {/* <label className="text-gray-700 font-semibold">اختر الشهر والسنة</label>
    ...
    <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                ...
                <p className="font-semibold text-xl">{userData[0]["إســــــم العــــــامل"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">المرتب الأساسى: </p>
                <p className="font-semibold text-xl">{userData[0]["المرتب الأساسى"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">حافز خبرة: </p>
                <p className="font-semibold text-xl">{userData[0]["حافز خبرة"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">حافز الإنتاج: </p>
                <p className="font-semibold text-xl">{userData[0]["حافز الإنتاج"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل تمثيل: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل تمثيل"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل وجبات: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل وجبات"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل إنتقالات: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل إنتقالات"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">حافز شهرى ثابت: </p>
                <p className="font-semibold text-xl">{userData[0]["حافز شهرى ثابت"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل جراج: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل جراج"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل تخصص: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل تخصص"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">العلاوات الخاصة: </p>
                <p className="font-semibold text-xl">{userData[0]["العلاوات الخاصة"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">علاوة غلاء معيشة: </p>
                <p className="font-semibold text-xl">{userData[0]["علاوة غلاء معيشة"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">منحة عيد العمال: </p>
                <p className="font-semibold text-xl">{userData[0]["منحة عيد العمال"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">أجر إضافى: </p>
                <p className="font-semibold text-xl">{userData[0]["أجر إضافى"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل صحراء: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل صحراء"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل وردية: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل وردية"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل تفرغ: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل تفرغ"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل حفر: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل حفر"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل إغتراب: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل إغتراب"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل صرافة: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل صرافة"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">إيرادات أخرى خاضعة: </p>
                <p className="font-semibold text-xl">{userData[0]["إيرادات أخرى خاضعة"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل مخاطر: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل مخاطر"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل موبايل: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل موبايل"]}</p>
              </div>
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-gray-600">بدل وردية: </p>
                <p className="font-semibold text-xl">{userData[0]["بدل وردية"]}</p>
               ...
               <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                ...
                <p className="font-semibold text-xl">{userData[0]["إجمالى الإستقطاعات"]}</p>
              </div>
              <div  className="bg-gray-50 p-4 rounded-lg text-center shadow-sm flex justify-between ">
                <p className="text-red-600">صافى الدخل</p>
                <p className="font-semibold text-xl">{userData[0]["صافى الدخل"]}</p>
              </div>
